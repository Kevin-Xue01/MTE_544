...
def euclidean(current_node, end_node):
    return sqrt((current_node[0] - end_node[0])**2 + (current_node[1] - end_node[1])**2)

def manhattan(current_node, end_node):
    return abs(current_node[0] - end_node[0]) + abs(current_node[1] - end_node[1])
...
def search(maze, start, end, heuristic):
    ...
    while len(yet_to_visit_dict) > 0:
        ...
        for new_position in move:
            ...
            if node_position[0] < 0 or node_position[1] < 0 or node_position[0] >= no_rows or node_position[1] >= no_columns:
                continue
        ...
        for child in children:
            ...
            child.g = child.parent.g + euclidean(child.position, child.parent.position)
